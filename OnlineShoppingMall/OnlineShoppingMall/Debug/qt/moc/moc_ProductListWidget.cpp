...
QT_MOC_LITERAL(1, 18, 15), // "productSelected"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 8), // "Product*"
QT_MOC_LITERAL(4, 44, 7) // "product"

    },
    "ProductListWidget\0productSelected\0\0"
    "Product*\0product"
};
...
void ProductListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->productSelected((*reinterpret_cast< Product*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProductListWidget::*)(Product * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProductListWidget::productSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProductListWidget::productSelected(Product * _t1)
{
